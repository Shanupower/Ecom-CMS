...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    itemsPrice: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    OrigialPrice: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUserAccountUserAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    alternatePhone: Schema.Attribute.BigInteger;
    ...
    wishlists: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
  };
}
